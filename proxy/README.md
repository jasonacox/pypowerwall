...
* Grid Charging: `/control/grid_charging` value=true/false token=$PW_CONTROL_SECRET
* Grid Export: `/control/grid_export` value=battery_ok/pv_only/never token=$PW_CONTROL_SECRET
