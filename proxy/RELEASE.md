...
* Upgraded to pyPowerwall v0.18.1 (Tesla tariff API, v1r LAN-down failover to the WiFi host, race-free failover recovery, and the new `failover` option — see library release notes)
