...
class TeslaCloud:
    def __init__(self, email, timezone, pwcacheexpire=5, timeout=10):
        self.email = email
    ...
    """
    site = tesla.battery_list() + tesla.solar_list()
    site = site[0]
    site.api("SITE_DATA")
        {'response': {'solar_power': 0, 'energy_left': 17790.473684210527, 
        total_pack_energy': 25941, 'percentage_charged': 68.58052382024798, 
        'backup_capable': True, 'battery_power': 1350, 'load_power': 1350, 
        'grid_status': 'Active', 'grid_services_active': False, 'grid_power': 0, 
        'grid_services_power': 0, 'generator_power': 0, 'island_status': 'on_grid', 
        'storm_mode_active': False, 'timestamp': '2023-12-16T18:18:34-08:00', 
        'wall_connectors': []}}
    """
    def setup(self):
        """
        ...
        try:
            ...
            for site in tesla.battery_list() + tesla.solar_list():
                ...
                try:
                    ...
                    if args.debug:
                        print(f"Get SITE_CONFIG for Site ID {
