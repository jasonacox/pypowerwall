...
def _remote_login() -> tuple:
    ...
    print("copy BOTH tokens shown and paste them here.")
    print()
    print("  ⚠️  IMPORTANT: The access token (AT) is required for cloud mode")
    print("  ⚠️  to work. Tesla now rejects refreshed tokens on owner-api.")
    print("  ⚠️  The AT is valid for ~8 hours; re-run setup when it expires.")
    print()
