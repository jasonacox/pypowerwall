...
def fixture_powerwall():
    # Instantiate Powerwall with mocked connect to avoid real network calls
    with unittest.mock.patch.object(Powerwall, 'connect', return_value=True), \
         unittest.mock.patch.object(Powerwall, 'din', return_value='DIN123'):
